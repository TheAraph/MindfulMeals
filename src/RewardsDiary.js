...
const RewardsDiary = () => {
  ...
  // Function to handle adding the diary entry to the RewardsDiary array in Firebase
  const handleConfirm = () => {
    ...
    if (currentUser) {
      ...
      // Update the RewardsDiary array in the user document with the new diary entry
      userRef.update({
  ...
  return (
    ...
    <Image 
    style={{height: 150, width: 350, borderRadius: 20,}} 
    source={require('../assets/Rewards.png')}>
    </Image>
    </View>
    <View style={{marginTop:20}}></View>
    <Text style={[globalStyles.Headline6Bold, {textAlign: 'center'}]}>This feature aims to encourage the user to finish their daily calories</Text>
