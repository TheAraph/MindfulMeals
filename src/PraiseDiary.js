...
import { StyleSheet, Text, View, SafeAreaView, Pressable, Button, TextInput, TouchableOpacity, Image } from 'react-native';
...
const PraiseDiary = () => {
  ...
  // Function to handle adding the diary entry to the PraiseDiary array in Firebase
  const handleConfirm = () => {
    ...
    if (currentUser) {
      ...
      // Update the PraiseDiary array in the user document with the new diary entry
      userRef.update({
        praiseDiary: firebase.firestore.FieldValue.arrayUnion({
          diaryText: diaryText,
  ...
  return (
    ...
    <Image 
    style={{height: 350, width: 350, borderRadius: 18,}} 
    source={require('../assets/IMG_6950.png')}>
    </Image>
    </View>
    <View style={{marginTop:20}}></View>
    <Text style={[globalStyles.Headline6Bold, {textAlign: 'center'}]}>This feature aims to praise and congratulate the user with text and confetti</Text>
