...
const TailoringDiary = () => {
  ...
  // Function to handle adding the diary entry to the TailoringDiary array in Firebase
  const handleConfirm = () => {
    ...
    if (currentUser) {
      ...
      // Update the TailoringDiary array in the user document with the new diary entry
      userRef.update({
        tailoringDiary: firebase.firestore.FieldValue.arrayUnion({
          diaryText: diaryText,
  ...
  return (
    ...
    <View style={{marginTop:20}}></View>
    <Text style={[globalStyles.Headline6Bold, {textAlign: 'center'}]}>This feature aims to tailor the Health page based on the user's preferences, and reminds the user that it is their choice whether to track calories and weight progress</Text>
